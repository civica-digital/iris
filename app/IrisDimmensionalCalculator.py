...
class IrisDimmensionalCalculator(Thread):
	...
	def read_data(self, auth, docid):
		...
		question_list = worksheet.row_values(0)
	...
	def extract_data(self, raw_data):
		...
		variable_names_per_question = {'Marca temporal':'timestamp','¿Cuáles son los líderes aliados de manera extraoficial al proyecto de Datos Abiertos para su ciudad?':'lead_official','¿Cuáles son los líderes aliados oficiales al proyecto de Datos Abiertos para su ciudad?':'lead_unofficial','¿Cuál es el presupuesto considerado por su equipo para el mantenimiento de la política de datos abiertos para su ciudad para este año?':'funds_budget','¿Cuáles fuentes de financiamiento están siendo consideradas para el mantenimiento del programa de datos abiertos?':'funds_sources','¿Cuáles fuentes de financiamiento están en proceso para ser entregado para el programa de Datos Abiertos?':'funds_inprocess','¿Cuáles fuentes de financiamiento ya están en proceso de ser ejercidas en el programa de Datos Abiertos?':'funds_exercised','¿Qué porcentaje del presupuesto anual estimado para la política de datos abiertos, ya se encuentra en proceso o en ejercicio de los fondos mencionados anteriormente?':'funds_percentage','¿De qué tamaño es el equipo técnico detrás del proyecto de Datos Abiertos en su ciudad?':'cap_teamsize','¿Este equipo es externo o interno al ayuntamiento?':'cap_extteam','¿Cuántas horas de trabajo totales están asignadas por semana en el equipo para el trabajo de los datos abiertos por semana?':'cap_od_time','¿Su ciudad cuenta ya con una herramienta especializada para la gestión de datos abiertos? Si así es, ¿Cuál?':'cap_od_tools','Indique, separados coma, los diferentes datos que se piden para hacer disponible un conjunto de datos específico':'cap_metadata','¿Cuál es el presupuesto asignado anual para la gestión y mantenimiento de las plataformas de datos abiertos para el año?':'cap_management','¿Cuál es la frecuencia promedio con la que se actualizan los datos que generan sus aliados en la plataforma?':'cap_frequency','¿Existe un encargado de la administración y verificación de la calidad de los datos?':'cap_quality','¿Existe una metodología escrita para la verificación de la calidad de los datos?':'cap_methodology','¿Qué herramientas de administración de contenido se usan en su proyecto?':'cap_content_tools','¿Cuál es el presupuesto anual asignado para la administración de contenido?':'cap_content_budget','¿Cuántas horas hombre están asignadas por semana para la administración de contenido alrededor de los datos abiertos?':'cap_content_time','¿Con cuantos conjuntos de datos diferentes se cuentan en estado de archivos físicos?':'opn_physical','¿Con cuantos conjuntos de datos diferentes se cuentan con archivos de hojas escaneadas, sin texto seleccionable?':'opn_scans','¿Con cuantos conjuntos de datos diferentes se cuentan en estado de archivos de hoja de cálculo(Microsoft Excel, OpenOffice Calc)?':'opn_spreadsheets','¿Con cuantos conjuntos de datos diferentes se cuentan en estado de archivos de formato abierto (CSV,TSV,JSON,TXT,etc)?':'opn_plaintext','¿Con cuantos conjuntos de datos diferentes se cuentan en estado de archivos  de información geográfica (Shapefiles, KML, etc)?':'opn_geospatial','¿Cuántas capacitaciones se han realizado en el marco del programa de datos abiertos de su ciudad?':'opn_training','¿Qué porcentaje de estas capacitaciones han sido con un enfoque Técnico?':'opn_training_technical','¿Qué porcentaje de estas capacitaciones han sido con un enfoque Organizacional?':'opn_training_org','¿Qué porcentaje de estas capacitaciones han sido con un enfoque Legal?':'opn_training_legal','¿Cuántas agencias en total han participado en estos programas?':'opn_training_agencies','¿Cual licencia de datos es usada con mayor frecuencia en su programa de datos abiertos?':'leg_license','¿Cuál es la razón por la que se usa esta licencia?':'leg_license_comments','Por favor, liste las organizaciones civiles aliadas al programa de datos abiertos o a las agencias gubernamentales para el consumo de datos abiertos.':'soc_allies','¿Tiene en puerta un evento de consumo de datos abiertos?':'soc_events','¿Tiene conocimiento del decreto de datos abiertos de México?':'leg_decree','¿En que estatus se encuentra la modificación del reglamento local para la inclusión de datos abiertos?':'leg_local_status','A partir de su respuesta anterior. Si no está considerada ¿Porqué? Si está en planeación ¿Dónde se publican los avances? Si ya está establecida ¿Dónde se puede localizar?':'leg_local_reference','¿En que estatus se encuentra la modificación del reglamento local para la inclusión de datos abiertos?':'leg_state_status','A partir de su respuesta anterior. Si no está considerada ¿Porqué? Si está en planeación ¿Dónde se publican los avances? Si ya está establecida ¿Dónde se puede localizar?':'leg_state_reference','¿Ha considerado la inclusión de un mecanismo de auto evaluación para el programa de datos abiertos que lidera?':'imp_self_assessment','¿Cuál es el sistema de bases de datos empresarial que el ayuntamiento usa para el almacenamiento de datos?':'cap_dbms','¿Cuántas horas hombre están asignadas por semana para el diseño y mantenimiento estético de los recursos de datos abiertos?':'cap_design'}
		answers_dict = {}
		for key in raw_data:
			variable = variable_names_per_question[key]
			answers_dict[key] = raw_data[key]
		return answers_dict
